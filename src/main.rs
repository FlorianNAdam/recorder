...
struct Args {
    ...
    #[arg(long, env = "SESSION_TIMEOUT", value_parser = humantime::parse_duration, default_value = "1d")]
    ...
    #[arg(long, env = "POLL_INTERVAL", value_parser = humantime::parse_duration, default_value = "20m")]
